        ...
        <div class="max-w-4xl w-full">
          <nav class="mb-8">
            <div class="flex items-center space-x-2 text-gray-300 text-sm">
              ...
              <a href="news.html" class="hover:text-white transition-colors">Berita</a>
              <i class="fas fa-chevron-right text-xs"></i>
                ...
                <section class="mb-12">
                  ...
                  <figure
                    ...
                    <blockquote
                      ...
                      <i
                        class="fas fa-quote-left text-red-200 text-4xl absolute -top-2 -left-2 opacity-50"></i>"Ini adalah langkah modernisasi pelayanan kependudukan.
                      ...
                      <div class="flex-1">
                        <div class="bg-slate-50 rounded-2xl p-4">
                          <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-slate-500">2 jam lalu</span>
                          </div>
                      ...
                      <div class="flex-1">
                        <div class="bg-slate-50 rounded-2xl p-4">
                          <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-slate-500">4 jam lalu</span>
                          </div>
                          <p class="text-slate-700">
                      ...
                      <div class="flex-1">
                        <div class="bg-slate-50 rounded-2xl p-4">
                          <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-slate-500">6 jam lalu</span>
                          </div>
                          <p class="text-slate-700">
                  ...
                  <div class="grid grid-cols-1 gap-6">
                    <a href="#" class="related-news-card block group">
                      <div class="h-40 overflow-hidden rounded-lg relative">
                        ...
                        <span
                          class="absolute top-3 right-3 bg-red-600 text-white text-xs font-semibold px-2.5 py-1 rounded-full">Pemerintahan</span>
                      </div>
                      <div class="p-6">
                        ...
                        <p
                          ...
                          data-time="2024-07-20T10:30:00"></p>
                      </div>
                    </a>
                    <a href="#" class="related-news-card block group">
                      <div class="h-40 overflow-hidden rounded-lg relative">
                      ...
                      <div class="p-6">
                        ...
                        <p
                          class="text-sm text-gray-500"
                          data-time="2024-07-18T15:45:00"></p>
                      </div>
                    </a>
                  </div>
                </div>
