...
<html lang="id">
  ...
  <body class="bg-gray-50">
          ...
          <div class="max-w-4xl w-full">
            <nav class="mb-8">
              <div class="flex items-center space-x-2 text-gray-300 text-sm">
                ...
                <a href="attent.html" class="hover:text-white transition-colors"
                  >Pengumuman</a
                >
                <i class="fas fa-chevron-right text-xs"></i>
                <span class="text-white font-medium">Detail Pengumuman</span>
              </div>
            </nav>
            ...
            <div class="flex flex-wrap gap-3 text-sm text-white mt-6">
          ...
          <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
              <div class="lg:col-span-2 space-y-12">
                ...
                >
                  ...
                  >
                    <p class="text-sm text-white italic">
                      Momen ujian CPNS 2024 di Tanjungpinang Kota
                    </p>
                  </div>
                </div>
                ...
                >
                  <div
                    class="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-xl mb-8"
                  >
                    <p class="text-gray-800 leading-relaxed text-md text-justify">
                      <span class="text-red-600 font-bold">Tanjungpinang</span> - Kelurahan Tanjungpinang Kota mengadakan sosialisasi E-KTP Digital untuk seluruh Ketua RT dan RW se-Kelurahan. Acara ini bertujuan memberikan pemahaman tentang penggunaan dan manfaat E-KTP Digital dalam pelayanan administrasi kependudukan.
                    </p>
                  </div>
                  <section class="mb-12">
                    ...
                    <figure
                      class="bg-white p-6 rounded-xl shadow-lg border  my-8"
                    >
                      <blockquote
    ...
    <footer class="main-footer relative">
      ...
      <div class="floating-element absolute bottom-10 left-10 w-16 h-16 rounded-full bg-accent-color/20"></div>
      <div class="floating-element absolute top-20 right-20 w-24 h-24 rounded-full bg-white/5"></div>
  </footer>
