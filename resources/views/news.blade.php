        ...
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex items-center space-x-6">
            <div class="hidden md:flex items-center space-x-1 ml-8">
              <a href="index.blade.php" class="nav-item">
                <i class="fas fa-home mr-2"></i> Beranda
              </a>
              <a href="news.blade.php" class="nav-item active">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        ...
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 2.1k</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 1 Juli
                          2025</span
                        >
                        <span class="ml-3"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 15 Juli
                          2025</span
                        >
                        <span class="ml-3"
