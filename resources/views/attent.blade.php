...
<html lang="id">
  <head>
    ...
    <style>
      ...
      .latest-news-item {
        position: relative;
        padding-bottom: 50px; /* Space for fixed metadata */
      ...
      .latest-news-item h4 {
        ...
        min-height: 3em; /* Ensure consistent height for 2 lines */
      }
      ...
      .latest-news-item:hover h4 {
        color: #dc2626 !important; /* Red title on card hover */
      }
    </style>
  </head>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex items-center space-x-6">
            <div class="hidden md:flex items-center space-x-1 ml-8">
              ...
              <a href="attent.html" class="nav-item active">
    ...
    >
      ...
      >
        ...
        <div class="absolute inset-0 overflow-hidden">
          <div
            class="absolute -top-40 -left-40 w-80 h-80 bg-gradient-to-r from-primary-600/20 to-red-600/20 rounded-full blur-3xl animate-pulse"
          ></div>
          <div
              ...
              <div class="max-w-4xl w-full">
                ...
                >
                  ...
                  <span class="block text-red-300"
                    >Segera daftarkan diri kamu</span
                  >
                </h1>
              ...
              <div class="max-w-4xl w-full">
                ...
                <div class="mt-8">
                  ...
                  >
                    <span class="text-lg">Baca Selengkapnya</span>
                    <i
                      class="fas fa-arrow-right ml-3 text-lg group-hover:translate-x-1.5 transition-transform duration-300"
                    ></i>
                  </a>
                </div>
              </div>
        ...
        <div class="news-hero-controls container mx-auto relative z-30 px-6">
          <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2">
            <div class="news-hero-nav flex items-center gap-3">
              ...
              >
                <i
                  class="fas fa-chevron-left text-base group-hover:scale-110 transition-transform duration-300"
                ></i>
              ...
              >
                <i
                  class="fas fa-chevron-right text-base group-hover:translate-x-0.5 transition-transform duration-300"
                ></i>
            ...
            <div class="space-y-4">
              <a href="#" class="group block">
                <div class="flex items-start gap-3">
                  <div
                    class="flex-shrink-0 w-3 h-3 mt-1.5 bg-red-500 rounded-full animate-pulse"
                  ></div>
                  <div>
                    <h4
      ...
      <section id="all-news" class="py-12 md:py-16 relative -mt-10">
        <div class="fixed-container">
          ...
          >
            ...
            >
              <div
                class="absolute inset-0 bg-gradient-to-br from-primary-500/5 via-transparent to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ></div>
            ...
            >
              <div
                class="absolute inset-0 bg-gradient-to-br from-green-500/5 via-transparent to-primary-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ></div>
              <div class="relative z-10 h-full flex flex-col">
                <div
                  class="relative overflow-hidden rounded-t-2xl aspect-[4/3]"
            ...
            >
              <div
                class="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-primary-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ></div>
              <div class="relative z-10 h-full flex flex-col">
                <div
                  class="relative overflow-hidden rounded-t-2xl aspect-[4/3]"
          ...
          <div class="flex justify-center mt-20" id="pagination-container">
            ...
            >
              <div
                class="absolute -inset-1 bg-gradient-to-r from-primary-600 to-red-700 rounded-3xl blur opacity-20"
              ></div>
      ...
      >
        <div class="fixed-container">
          ...
          >
            <div
              class="absolute -top-20 -right-20 w-64 h-64 bg-primary-500/10 rounded-full blur-3xl -z-10"
            ></div>
            <div
              class="absolute -bottom-20 -left-20 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl -z-10"
            ></div>
            ...
            <div class="flex justify-center border-b border-gray-200/50 mb-8">
              ...
              >
                <span>Penting</span>
                <div
                  class="absolute bottom-0 left-0 right-0 h-1 bg-primary-600 rounded-t-full transition-all duration-300 opacity-100"
                ></div>
              </button>
              <button
              ...
              >
                <span>Terbaru</span>
                <div
                  class="absolute bottom-0 left-0 right-0 h-1 bg-primary-600 rounded-t-full transition-all duration-300 opacity-0"
                ></div>
              </button>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 10 Juli 2025</span>
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 2.5K</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 2 Juli
                          2025</span
                        >
                        <spansemua class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 2.2k</spansemua
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 8 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 1.75K</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 5 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 2k</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 3 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 2.4K</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 1 Juli 2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 1.1K</span
                        >
                      </div>
                    </div>
                  </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 15 Juli 2025</span>
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 1.2K</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 14 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 980</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 13 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 1.3K</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 12 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 720</span
                        >
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        <span
                          ><i class="far fa-calendar-alt mr-1"></i> 10 Juli
                          2025</span
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 2.4K</span
                  ...
                  >
                    <div class="flex-1">
                      ...
                      <div class="flex items-center text-sm text-gray-500 mt-2">
                        ...
                        >
                        <span class="ml-3"
                          ><i class="far fa-eye mr-1"></i> 1.8K</span
                        >
                      </div>
                    </div>
                  </a>
            ...
            <div class="text-center mt-12">
              ...
              >
                <i
                  class="fas fa-newspaper mr-3 group-hover:scale-110 transition-transform duration-300"
                ></i>
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li class="flex items-start">
                <i
                  class="fas fa-map-marker-alt text-accent-color mt-1 mr-3"
                ></i>
                <span class="text-gray-300"
                  >Jl. Kuantan No.1, Tanjungpinang Kota, Kec. Tanjungpinang
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-300"
                  >tpikotakel@tanjungpinangkota.go.id</span
                >
              </li>
              <li class="flex items-center">
